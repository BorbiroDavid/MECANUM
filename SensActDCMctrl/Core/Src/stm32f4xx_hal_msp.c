...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(PSENSE_AIN_GPIO_Port, PSENSE_AIN_Pin);

    HAL_GPIO_DeInit(GPIOC, VPOT1_AIN_Pin|VPOT2_AIN_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, ANGS_MISO_Pin|ANGS_MOSI_Pin);

    HAL_GPIO_DeInit(ASENS_SCK_GPIO_Port, ASENS_SCK_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(RPSM_QA_GPIO_Port, RPSM_QA_Pin);
